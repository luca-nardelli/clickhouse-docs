...
//          { from: '/en/guides/developer/', to: '/en/guides' },
          ...
          { from: '/en/integrations/kafka/kafka-connect-jdbc', to: '/en/integrations/kafka/#jdbc-connector' },
          { from: '/en/integrations/kafka/kafka-vector', to: '/en/integrations/kafka/#using-vector-with-kafka-and-clickhouse' },
          { from: '/en/integrations/kafka/clickhouse-kafka-connect-sink', to: '/en/integrations/kafka/#clickhouse-kafka-connect-sink' },
          { from: '/en/engines/table_engines/integrations/kafka', to: '/en/engines/table-engines/integrations/kafka' },
          { from: '/en/integrations/kafka/kafka-connect-http', to: '/en/integrations/kafka/#confluent-http-sink-connector' },
          { from: '/en/integrations/kafka/kafka-connect-options', to: '/en/integrations/kafka/#choosing-an-option' },
